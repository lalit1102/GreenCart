    ...
    <div className="max-w-6xl w-full px-6">
      ...
      <div className="flex flex-col md:flex-row gap-16 mt-4">
        <div className="flex flex-col-reverse sm:flex-row gap-3 sm:w-1/2">
          ...
          <div className="border border-gray-500/30 sm:w-[80%] rounded w-full">
        ...
        <div className="text-sm w-full md:w-1/2">
          ...
          <div className="flex items-center mt-10 gap-4 text-base">
            ...
            <button onClick={() => { addToCart(product._id); navigate("/cart") }} className="w-full py-3.5 cursor-pointer font-medium bg-indigo-500 text-white hover:bg-indigo-600 transition" >Buy Now</button>
          </div>
        </div>
      </div>
      {/* // relatedProducts */}
      <div className="flex flex-col items-center mt-20">
        <div className="flex flex-col items-center w-max">
          ...
          <div className="w-20 h-0.5 bg-green-500/20 rounded-full mt-2"></div>
        </div>
        ...
        <button onClick={() => { navigate("/products"); scrollBy(0, 0) }} className="mx-auto cursor-pointer px-12 my-16 py-2.5 border rounded text-green-500/80 hover:bg-green-500/30 transition">see more</button>
      </div>
    </div>
